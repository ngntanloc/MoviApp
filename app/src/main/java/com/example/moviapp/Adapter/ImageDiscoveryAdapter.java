...
public class ImageDiscoveryAdapter extends RecyclerView.Adapter<ImageDiscoveryAdapter.MyViewHolder> {

    private List<MovieModel> movies = new ArrayList<>();
    private Context context;

    public ImageDiscoveryAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(Credentials.GET_IMAGE + movie.getBackdrop_path())
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            imgDiscovery = itemView.findViewById(R.id.imgDiscovery);
        }
    }
